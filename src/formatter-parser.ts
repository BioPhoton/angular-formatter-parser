...
const convertMaskToPlaceholder = function (mask: (string | RegExp)[], placeholderChar: string): string {
...
export class FormatterParser {
  ...
  static conformToMask(mask: (string | RegExp)[] | Function = emptyArray, config: IConformToMaskConfig) {
    ...
    const placeholderChar = config.placeholderChar || defaultPlaceholderChar;
